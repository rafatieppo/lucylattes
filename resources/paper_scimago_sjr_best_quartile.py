"""Return best scimago quartile for journals from a assigned csv."""

import pandas as pd


def paper_scimago_sjr_bq(ls_per_issn):
    """Return jcr for papers from a assigned csv."""
    path_jcr = './jcr_qualis/scimago_factor.csv'
